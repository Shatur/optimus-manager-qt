...
[Full Changelog](https://github.com/Shatur95/optimus-manager-qt/compare/1.4.6...HEAD)
...
[Full Changelog](https://github.com/Shatur95/optimus-manager-qt/compare/1.4.3...1.4.4)

**Changed**

-   Fix build for Qt 5.14.

## [1.4.3](https://github.com/Shatur95/optimus-manager-qt/tree/1.4.3) (2019-12-04)

[Full Changelog](https://github.com/Shatur95/optimus-manager-qt/compare/1.4.2...1.4.3)

**Changed**

-   Follow Freedesktop naming conventions for .desktop file.

## [1.4.2](https://github.com/Shatur95/optimus-manager-qt/tree/1.4.2) (2019-11-17)

[Full Changelog](https://github.com/Shatur95/optimus-manager-qt/compare/1.4.1...1.4.2)

**Changed**

-   Fix kernel modules parsing.
