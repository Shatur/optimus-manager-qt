...
Все равно продолжить?</translation>
    ...
    <message>
        ...
        <translation>Не удалось подключиться к демону Optimus Manager для переключения GPU: %1</translation>
    </message>
    <message>
...
Проигнорировать это предупреждение сейчас и перейти к переключению GPU?</translation>
    ...
    <message>
        ...
        <translation>Не удалось отправить имя GPU для переключения демону Optimus Manager: %1</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удается подключиться к демону optimus-manager для отправки режима запуска: %1</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Автоматически выходить из текущего сеанса рабочего стола при переключении GPU&lt;/p&gt;&lt;p&gt;В настоящее время это поддерживается только для Gnome, KDE Plasma, Deepin, Xfce, i3, Sway, Openbox и AwesomeWM&lt;/p&gt;&lt;p&gt;Если этот параметр отключен или вы используете другую среду рабочего стола, переключение GPU вступает в силу только при следующем входе в графическую сессию&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось найти демон Optimus Manager.</translation>
    </message>
    <message>
